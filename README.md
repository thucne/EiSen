...
2. The Windows MSIX listing is currently undergoing [Microsoft Store certification](https://apps.microsoft.com/detail/9NRLQNXFVBF8). Until it is live, use the Windows NSIS setup installer `.exe` from [GitHub Releases](https://github.com/thucne/EiSen/releases) or [eisen.a302.link/download](https://eisen.a302.link/download); the Store listing will become the recommended path after approval.
