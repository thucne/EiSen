...
- **Rich Structured Data (SEO):**
  - Schema.org `SoftwareApplication` (macOS 11.0+ & Windows 10/11, 100% Free, v0.2.4 direct links)
...
- **Direct Downloads & Fast Redirects:**
  - `/download/windows` and `/exe` 302 to GitHub Release `EiSen_0.2.4_x64-setup.exe` (~2.6 MB)
  - `/download/mac` and `/dmg` 302 to GitHub Release `EiSen_0.2.4_aarch64.dmg` (~4.2 MB)
